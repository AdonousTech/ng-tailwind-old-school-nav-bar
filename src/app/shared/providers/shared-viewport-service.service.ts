...
export class SharedViewportService extends Subject<IViewport> {
  ...
  viewportHandsetSubscription: Subscription;
  viewportTabletSubscription: Subscription;
  viewportWebSubscription: Subscription;

  viewportReport: IViewport;

  // observable boolean source for the initial viewport evaluation as well
